		...
		<div class="container">
		  ...
		  <div class="tabbable tabs-below">
			<ul class="nav nav-pills">
              ...
              <li class="active"><a href="return_livro.jsp">Retorno Livro</a></li>
...
c.setTime(new Date()); // Pega a data de Atual.
c.add(Calendar.DATE, 3); // Adiciona 5 dias.
String output = sdf.format(c.getTime());
String retorna_data=sdf.format(c.getTime());
...
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
*/
	String	sqlInsertItem="DELETE FROM adiciona_livro WHERE user_id='"+userid+"' AND livro_id='"+livroid+"'";
	pstInsertItem=con.prepareStatement(sqlInsertItem);
	pstInsertItem.executeUpdate();
	out.println("Retorno do Livro com sucesso");
	}
